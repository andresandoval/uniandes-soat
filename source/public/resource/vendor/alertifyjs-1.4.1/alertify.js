    ...
    var dialog = (function () {
        ...
        function initialize(instance) {
            ...
            if (!instance.__internal) {
                ...
                //<andres-was-here>
                instance.set('closableByEsc', setup.options.closableByEsc === undefined ? alertify.defaults.closableByEsc : setup.options.closableByEsc);
                //</andres-was-here>
        ...
        function keyupHandler(event) {
            ...
            //<andres-was-here>
            //  add "instance.get('closableByEsc') === true" on if clasuse
            //</andres-was-here>
            if (instance.__internal.buttons.length === 0 && keyCode === keys.ESC && instance.get('closable') === true && instance.get('closableByEsc') === true) {
                triggerClose(instance);
                return false;
...
//                //Andres estuvo aqui...
//                if (!(instance.settings.avoidKeyUpEvent === true)) {
//                }
//                //Hasta aqui...
